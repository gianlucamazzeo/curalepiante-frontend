<script lang="ts">
  ...
  onMount(() => {
    ...
    // Carica le piante con i filtri iniziali usando l'endpoint dedicato per le piante da interno
    pianteStore.fetchIndoorPlants(initialFilters);
  ...
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    ...
    {:else}
      ...
      <div class="mb-6 text-gray-600">
        <p>
          Mostrando {$pianteStore.piante.length} di {$pianteStore.pagination.total} piante da interno
